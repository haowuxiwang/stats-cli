...
def test_tost_equivalent():
    ...
    from stats_engine.equivalence import equivalence
    result = equivalence(test_type="tost", values=[10.0, 10.1, 10.0, 10.1, 10.0],
                         values2=[10.05, 10.15, 10.05, 10.15, 10.05], delta=0.5)
...
def test_tost_not_equivalent():
    ...
    from stats_engine.equivalence import equivalence
    result = equivalence(test_type="tost", values=[10, 10, 10, 10, 10],
                         values2=[20, 20, 20, 20, 20], delta=0.5)
...
def test_one_sample_tost_fields():
    ...
    from stats_engine.equivalence import equivalence
    result = equivalence(test_type="one_sample_tost", values=[10.0, 10.1, 10.2, 10.0, 10.1],
                         mu=10.0, delta=0.5)
...
def test_tost_custom_alpha():
    ...
    from stats_engine.equivalence import equivalence
    result = equivalence(test_type="tost", values=[10, 10.1, 10.2],
                         values2=[10.05, 10.15, 10.25], delta=0.5, alpha=0.10)
